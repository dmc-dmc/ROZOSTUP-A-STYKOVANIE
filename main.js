...
function collectFormData() {
    return {
        ...
        // Dolná výstuž
        phi_sl_bottom: parseFloat(document.getElementById('phi_sl_bottom').value),
        n_bottom: parseInt(document.getElementById('n_bottom').value),
        
        // Horná výstuž
        phi_sl_top: parseFloat(document.getElementById('phi_sl_top').value),
        n_top: parseInt(document.getElementById('n_top').value),
        
        // Strmene
        phi_ss: parseFloat(document.getElementById('phi_ss').value),
        ...
        anchoragePhi: parseFloat(document.getElementById('anchorage-phi').value)
    };
}
...
function fillFormWithData(data) {
    ...
    // Dolná výstuž
    document.getElementById('phi_sl_bottom').value = data.phi_sl_bottom || '';
    document.getElementById('n_bottom').value = data.n_bottom || '';
    
    // Horná výstuž
    document.getElementById('phi_sl_top').value = data.phi_sl_top || '';
    document.getElementById('n_top').value = data.n_top || '';
    
    // Strmene
    document.getElementById('phi_ss').value = data.phi_ss || '';
    ...
    document.getElementById('anchorage-phi').value = data.anchoragePhi || '';
}
...
function calculateAndDisplaySpacing() {
    ...
    const phi_sl_bottom = parseFloat(document.getElementById('phi_sl_bottom').value);
    const n_bottom = parseInt(document.getElementById('n_bottom').value);
    const phi_sl_top = parseFloat(document.getElementById('phi_sl_top').value);
    const n_top = parseInt(document.getElementById('n_top').value);
    const phi_ss = parseFloat(document.getElementById('phi_ss').value);
...
function calculateAndDisplayAnchorage() {
    ...
    const phi = parseFloat(document.getElementById('anchorage-phi').value);
